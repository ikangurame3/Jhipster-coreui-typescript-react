...
const Dashboard: React.FC = () => {
  ...
  /** TODO: fix ButtonDropdown toggle
   * The toggle is applying to all cards
   * Should aply only to specific card
   */
      ...
      <Row>
        ...
        <Col xs="12" sm="6" lg="3">
          <Card className="text-white bg-info">
            <CardBody className="pb-0">
              <ButtonGroup className="float-right">
                <Dropdown isOpen={cardIsOpen} toggle={toggleCardOpen}>
        ...
        <Col xs="12" sm="6" lg="3">
          <Card className="text-white bg-danger">
            <CardBody className="pb-0">
              <ButtonGroup className="float-right">
                <ButtonDropdown isOpen={cardIsOpen} toggle={toggleCardOpen}>
                  <DropdownToggle caret className="p-0" color="transparent">
                    <i className="icon-settings" />
                  </DropdownToggle>
                  <DropdownMenu right>
