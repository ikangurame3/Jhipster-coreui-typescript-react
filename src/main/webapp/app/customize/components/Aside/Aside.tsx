  ...
  return (
    <aside className="aside-menu">
      <Nav tabs>
        <NavItem>
          <NavLink
            className={classnames({ active: activeTab.tab === "1" })}
            onClick={() => {
              toggle("1");
            }}
          >
        ...
        <NavItem>
          <NavLink
            className={classnames({ active: activeTab.tab === "2" })}
            onClick={() => {
              toggle("2");
            }}
          >
        ...
        <NavItem>
          <NavLink
            className={classnames({ active: activeTab.tab === "3" })}
            onClick={() => {
              toggle("3");
            }}
          >
      ...
      <TabContent activeTab={activeTab.tab}>
        <TabPane tabId="1">
